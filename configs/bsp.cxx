...
template<> const rt_base_t Relay<Port::A>::kPin = GET_PIN(C, 9);
template<> const rt_base_t Relay<Port::B>::kPin = GET_PIN(B, 6);

template<> const rt_base_t LoadDetector<Port::A>::kPin = GET_PIN(C, 8);
template<> const rt_base_t LoadDetector<Port::B>::kPin = GET_PIN(B, 5);
